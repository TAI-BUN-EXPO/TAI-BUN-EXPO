...
export const tshingtuann = [
  ...
  },
  {
	...
	hangbok: [
	    ...
	    {
		    too: require('./too/20191123 1430 你今仔日kám有講台語.png'),
		    bangtsi: 'https://www.facebook.com/events/408043233247829/',
		},
	    {
		    too: require('./too/20191124 0900 來去柴山.png'),
		    bangtsi: 'https://www.facebook.com/events/483413442212897/',
		},
	    {
		    too: require('./too/20191124 1430 港台垃圾話垃圾講.png'),
  ...
  },
  {
	...
	hangbok: [
	    {
		    too: require('./too/20191130 0900 來去哈馬星行踏.png'),
	    ...
	    {
		    too: require('./too/20191130 1430 閉幕吳朋奉.png'),
